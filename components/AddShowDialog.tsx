    ...
    >
      ...
      >
        ...
        <div className="px-5 pt-4">
          ...
          <div className="flex items-center gap-2.5 rounded-xl border border-border-subtle bg-background/40 px-3.5 py-2.5 transition-colors focus-within:border-accent">
